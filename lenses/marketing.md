---
name: marketing
description: The default lens. Landing pages, product pages, emails and ads — copy whose job is to make a stranger keep reading.
voices: Steve Krug (Don't Make Me Think, 2000), Daniel Priestley (pitch order), Alex Hormozi ($100M Offers, 2021)
triggers: landing page, homepage, hero, cta, call to action, pricing, sign up, book a, free quote, testimonials, our services, get started, features, plans
---

# Marketing

The default. Nothing selects it; it is what you get when no other lens is asked for.
...
REGISTER: Marketing copy. A landing page, a product page, an email, an ad. Short lines,
plain words, and no sentence that survives only because it scans well.
READER: A buyer who did not ask for this page and will leave in seconds. They are
scanning for whether this is for them and what it costs to find out. They have been
sold to badly before, and they are waiting for the moment this page does it too.
PASS 3 FOR THIS LENS:
- One specific number, name or date per claim, drawn ONLY from the source text.
- Vary sentence length hard. A three-word sentence after a long one.
- Say one thing a cautious writer would have cut: an opinion, a preference, a failure.
- Keep one rough edge: a contraction, a fragment, a sentence starting with "And".
- Prefer a specification to an adjective. `Six nails per shingle` beats `meticulous`.
- A refusal earns more than a promise. Keep any line that says what is not on offer.
- One ask per screen, and the button says what it does.
